<script>
    ...
    async function hideSettings() {
      if (friendIdentifier !== "") { dispatch("getInviteSlots"); }
      showModal = false;
    }
    ...
    <div on:click|stopPropagation class="divider">
      <div>
        ...
        <div class="settings-wrapper">
          <p>You have <b>{ friendInviteSlots.availableSlots == -1 ? '∞' : `${friendInviteSlots.availableSlots - friendInviteSlots.previousInvites}/${friendInviteSlots.availableSlots}`}</b> invites left.<br>You can use them to invite a friend to the NRC closed beta.</p>
