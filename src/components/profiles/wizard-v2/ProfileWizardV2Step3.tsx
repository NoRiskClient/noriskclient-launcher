...
export function ProfileWizardV2Step3({
  ...
  useEffect(() => {
    const checkPackCompatibility = async () => {
      ...
      try {
        ...
        const hasCompatibleNoRiskClient = mods.some(
          (mod: NoriskModEntryDefinition) => {
            ...
            if (mod.id === "noriskclient-client" || mod.id === "nrc-client") {
              ...
              const versionCompat =
                mod.compatibility?.[selectedMinecraftVersion];
        ...
        <div className="grid grid-cols-1 gap-3">
          <div className="space-y-1">
            <Checkbox
              ...
              onChange={(event) =>
                setUseSharedMinecraftFolder(event.target.checked)
              }
                ...
                {loadingPacks ? (
                  ...
                  <>
                    <div className="flex gap-3">
                      <div className="flex-1">
                        <Select
                          ...
                          onChange={(value) =>
                            setSelectedNoriskPackId(value === "" ? null : value)
                          }
                          options={[
                            {
                              value: "",
                              label: t("profiles.wizard.noneOptional"),
                            },
                            ...noriskPackOptions,
                          ]}
                    ...
                    {showYellowWarning ? (
                      ...
                      selectedNoriskPackId &&
                      noriskPacks[selectedNoriskPackId] && (
                        <div className="text-center">
  ...
  const renderFooter = () => (
    <div className="flex justify-between items-center">
      ...
      >
        {creating
          ? t("profiles.wizard.creating")
          : t("profiles.wizard.createProfile")}
      </Button>
    </div>
  );
