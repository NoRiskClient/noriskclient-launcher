use noriskclient_launcher_v3_lib::minecraft::api::cosmetic_pack_api::merge_settings;
use noriskclient_launcher_v3_lib::minecraft::dto::cosmetic_outfit::{CosmeticSettings, Vector3f};
