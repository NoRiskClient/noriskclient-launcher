...
async fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::local_server_command::open_bedrock_profile_folder,
            commands::local_server_command::open_bedrock_profile_content,
            commands::local_server_command::delete_bedrock_profile_content,
