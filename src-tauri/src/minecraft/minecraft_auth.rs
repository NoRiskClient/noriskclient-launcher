...
impl MinecraftAuthStore {
    ...
    pub async fn login_finish(
        ...
        window
            .emit("microsoft-output", "XSTS Authorize")
            .unwrap_or_default();
