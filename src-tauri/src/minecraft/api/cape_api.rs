...
impl CapeApi {
    ...
    pub async fn get_player_outfit(
        ...
        let endpoint = format!("user/{}/outfit", player_uuid);
        let base_url = Self::get_api_base(is_experimental);
        let url = format!("{}/{}", base_url, endpoint);

        debug!(
            "[Cape API get_player_outfit] Fetching outfit for player_uuid: {}. URL: {}",
            player_uuid, url
        );
        ...
        let response = HTTP_CLIENT
            ...
            .await
            .map_err(|e| {
                error!("[Cape API get_player_outfit] Request failed: {}", e);
                AppError::RequestError(format!(
                    "Failed to send request to Cosmetics API for get_player_outfit: {}",
                    e
                ))
            })?;
    ...
    pub async fn get_player_icon(
        ...
        let base_url = Self::get_api_base(is_experimental);
        let url = format!("{}/icon/{}", base_url, player_uuid);
        ...
        let response = HTTP_CLIENT
            ...
            .await
            .map_err(|e| {
                error!("[Cape API get_player_icon] Request failed: {}", e);
                AppError::RequestError(format!(
                    "Failed to send request to Cosmetics API for get_player_icon: {}",
                    e
                ))
            })?;
    ...
    pub async fn get_shop_user(
        ...
        let base_url = Self::get_api_base(is_experimental);
        let url = format!("{}/store/user", base_url);
        ...
        let response = HTTP_CLIENT
            ...
            .await
            .map_err(|e| {
                error!("[Cape API get_shop_user] Request failed: {}", e);
                AppError::RequestError(format!(
                    "Failed to send request to Cosmetics API for get_shop_user: {}",
                    e
                ))
            })?;
